...
describe('Movie', function () {
    ...
    it('rent new release movie one day', () => {
        expect(moviePriceFor(new Rental(1,
    ...
    it('rent new release movie two day', () => {
        expect(moviePriceFor(new Rental(2, newReleaseConfiguration("UNUSED")))).toEqual(6.0)
    });

    it('rent children movie one day', () => {
        expect(moviePriceFor(new Rental(1, childrenConfiguration("UNUSED")))).toEqual(1.5)
    });
